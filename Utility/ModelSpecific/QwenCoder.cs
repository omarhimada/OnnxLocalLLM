/**
 * Example of manually converting a Jinja template to C#.
 */
...
//	if (((message.role == "user") || (message.role == "system" && index != 0)) || (message.role == "assistant" && !message.tool_calls)) {
...
//		sb.AppendLine(message.content);
//		sb.AppendLine("</tool_response>");
//		if ((index == messagesCount - 1) || (index + 1 < messagesCount) && (messages[index + 1].role != "tool")) {
//			sb.AppendLine("<|im_end|>");
//		}
//	}
